...
def handle_start(message):
    ...
    bot.send_photo(message.chat.id, "https://t.me/NsDevSpace/8", caption="Welcome! to Translator Bot Aurora 💚 \n Send Send the part you want to translate as text 💚", reply_markup=join_button())
